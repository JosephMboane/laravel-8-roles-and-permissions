...
{{--@section('content')--}}
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card" id="Bem">
                    <div class="card-header text-center'">{{ __('Seja Bem VInda ao Sistema') }} <strong>{{ Auth::user()->name }}</strong></div>
                    ...
                    <div class="card-body">
                        ...
                        @endif
                            ...
                            <a href="/change-password"> Clique aqui para mudar a sua senha</a>
                    </div>
                </div>
            </div>
        </div>

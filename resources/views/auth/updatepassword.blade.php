...
{{--                            <label for="password" class="col-md-4 col-form-label text-md-right">Current Password</label>--}}
                            ...
                            <div class="col-md-12 mt-3">
                                ...
                                <input id="password" type="password" placeholder="Antiga Palavra Pass" class="form-control text-center" name="current_password" autocomplete="current_password">
...
{{--                            <label for="password" class="col-md-4 col-form-label text-md-right">New Password</label>--}}
                            ...
                            <div class="col-md-12">
                                ...
                                <input id="new_password" type="password" placeholder="Nova Palavra Pass" class="form-control text-center" name="new_password" autocomplete="current-password">
...
{{--                            <label for="password" class="col-md-4 col-form-label text-md-right">New Confirm Password</label>--}}
                            ...
                            <div class="col-md-12">
                                ...
                                <input id="new_confirm_password" placeholder="Confirmação da Nova Palavra Pass" type="password" class="form-control text-center" name="new_confirm_password" autocomplete="current-password">
